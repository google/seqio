...
project = 'SeqIO'
copyright = '2023, The SeqIO authors'  # pylint: disable=redefined-builtin
author = 'The SeqIO authors'
...
html_css_files = ['css/seqio_theme.css']

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = './seqio.png'
html_favicon = './seqio.png'
...
html_theme_options = {
    'repository_url': 'https://github.com/google/seqio',
