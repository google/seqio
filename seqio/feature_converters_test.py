...
class StrictLMFeatureConverter(tf.test.TestCase):
  ...
  def test_lm_unpacked(self):
    ...
    converter = feature_converters.StrictLMFeatureConverter(pack=False)
    converted_ds = converter(ds, task_feature_lengths)
  ...
  def test_lm_only_packed(self):
    ...
    converter = feature_converters.StrictLMFeatureConverter(pack=True)
    converted_ds = converter(ds, task_feature_lengths)
...
class LMFeatureConverterTest(FeatureConvertersTest):
  ...
  def test_prefixlm(self):
    ...
    task_feature_lengths = {"inputs": 8, "targets": 7}
    converter = feature_converters.LMFeatureConverter(
        pack=True, loss_on_targets_only=False)
    converted_ds = converter(ds, task_feature_lengths)
